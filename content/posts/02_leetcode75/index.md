...
The objective of this project is to improve my coding skills (analisys and solving problems). Then some solutions may not be the most efficient in terms of time or space complexity, however I try to find the best approach based on my current understanding. In the future, as I continue to learn and develop new skills, I hooe to improve the project with better algorithms and efficiency solutions.
...
- [14 Maximum Average Subarray I](https://joelcae.github.io/leetcode-75/posts/14_643_Maximum_Average_Subarray_I.md)
- [15 Maximum Number of Vowels in a Substring of Given Length](https://joelcae.github.io/leetcode-75/posts/15_1456_Maximum_Number_of_Vowels_in_a_Substring_of_Given_Length.md)
- [16 Max Consecutive Ones III](https://joelcae.github.io/leetcode-75/posts/16_1004_Max_Consecutive_Ones_III.md)
- [17 Longest Subarray of 1's After Deleting One Element](https://joelcae.github.io/leetcode-75/posts/17_Longest_Subarray_of_1s_After_Deleting_One_Element.md)

- [18 Find the Highest Altitude](https://joelcae.github.io/leetcode-75/posts/18_1732_Find_the_Highest_Altitude.md)
- [19 Find Pivot Index](https://joelcae.github.io/leetcode-75/posts/19_724_Find_Pivot_Index.md)
